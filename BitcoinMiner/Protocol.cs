...
public class Client_Start : SendSession<Miner, mining, (byte[], System.Numerics.BigInteger), ReceiveSession<Miner, done, ContextFreeSession.Unit, Call<Client_Start, ReceiveSession<Reporter, result, (byte[], bool), Eps>>>, end, ContextFreeSession.Unit, Eps>, IStart { public string Role => "Client"; }
...
public class Reporter_Start : BranchSession<Miner, found, ReceiveSession<Miner, found, (byte[], System.Numerics.BigInteger), Call<Reporter_Start, SendSession<Client, result, (byte[], bool), Eps>>>, end, ReceiveSession<Miner, end, ContextFreeSession.Unit, Eps>>, IStart { public string Role => "Reporter"; }
