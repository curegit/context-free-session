...
public class Sender_Tree : SendSession<Receiver, node, ContextFreeSession.Unit, Call<Sender_Tree, Call<Sender_Tree, Eps>>, leaf, int, SendSession<Logger, leaf, int, Eps>> { }
...
public class Logger_Tree : ReceiveSession<Sender, leaf, int, Call<Logger_Tree_, Eps>> { }

public class Logger_Tree_ : BranchSession<Sender, leaf, Call<Logger_Tree, Call<Logger_Tree_, Eps>>, end, Eps> { }

public class Receiver_Start : Call<Receiver_Tree, Eps>, IStart { public string Role => "Receiver"; }

public class Receiver_Tree : BranchSession<Sender, node, ReceiveSession<Sender, node, ContextFreeSession.Unit, Call<Receiver_Tree, Call<Receiver_Tree, Eps>>>, leaf, ReceiveSession<Sender, leaf, int, Eps>> { }
