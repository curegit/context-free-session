...
public class A_Sub1 : BranchSession<B, sub1, ReceiveSession<B, sub1, ContextFreeSession.Unit, SendSession<C, tricky, ContextFreeSession.Unit, Eps>>, sub2, ReceiveSession<B, sub2, ContextFreeSession.Unit, Call<A_Sub2, Eps>>, sub3, ReceiveSession<B, sub3, ContextFreeSession.Unit, Eps>> { }

public class A_Sub2 : SendSession<C, super, string, Eps, uber, string, Eps> { }
...
public class B_Sub1 : SendSession<A, sub1, ContextFreeSession.Unit, Eps, sub2, ContextFreeSession.Unit, Eps, sub3, ContextFreeSession.Unit, Eps> { }
...
public class C_Sub1 : BranchSession<A, tricky, ReceiveSession<A, tricky, ContextFreeSession.Unit, Eps>, (super, uber), Call<C_Sub2, Eps>, (late, combo), Eps> { }

public class C_Sub2 : BranchSession<A, super, ReceiveSession<A, super, string, Eps>, uber, ReceiveSession<A, uber, string, Eps>> { }
